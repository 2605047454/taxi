...
public class Chooser extends JPanel {
	...
	private Chooser(Date date) {
		this(date, "yyyy-MM-dd");
	}
 
	private Chooser(String format) {
		this(new Date(), format);
	}
 
	private Chooser(Date date, String format) {
		initDate = date;
	...
	public void register(final JComponent showDate,JComponent selectComponent) {
	...
	private void commit() {
		...
		((JTextField) selectDate).setText(sdf.format(select.getTime()));
		hidePanel();
	}
	...
	private class MyLabel extends JLabel implements Comparator<MyLabel>, MouseListener, MouseMotionListener {
		...
		public void mouseExited(MouseEvent e) {
			 if(month == select.get(Calendar.MONTH)) this.setForeground(java.awt.Color.BLACK);
