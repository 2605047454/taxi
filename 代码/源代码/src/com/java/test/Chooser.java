...
public class Chooser extends JPanel{
	...
	// 日期变量    传给frame
	public static String transportDate;
	/*public BroadCastFrame frame;
	public void setFrame(BroadCastFrame frame){
		this.frame = frame;
	}
	public BroadCastFrame getFrame(BroadCastFrame frame){
		return frame;
	}*/
	

    public static final long serialVersionUID = -5384012731547358720L;
    
    public Calendar calendar;
    public Calendar now = Calendar.getInstance();
    public JPanel calendarPanel;
    public java.awt.Font font = new java.awt.Font("Times",java.awt.Font.PLAIN,12);
    public java.text.SimpleDateFormat sdf;
    public  LabelManager lm = new LabelManager();
    public javax.swing.Popup pop;
    public TitlePanel titlePanel;
    public BodyPanel bodyPanel;
    public FooterPanel footerPanel;
    
    public  JComponent showDate;
    public  JComponent selectDate;
    public boolean isShow = false;
    public static final String DEFAULTFORMAT = "yyyy-MM-dd";
    public static final String[] showTEXT = {"周日","周一","周二","周三","周四","周五","周六"};
    public static WeekLabel[] weekLabels = new WeekLabel[7];
    public static int defaultStartDAY = 0;//0 is from Sun, 1 is from Mon, 2 is from Tue

    public Chooser(java.util.Date date, String format, int startDAY){
	...
	public void register( JComponent showComponent, JComponent selectComponent) {
        this.showDate = showComponent;
        this.selectDate = selectComponent;
    ...
    public String commit() {
    	...
    	((JTextField) selectDate).setText(sdf.format(calendar.getTime()));
    	
        hidePanel();			
	//	transportDate = ((JTextField) showDate).getText();
	//	History.selectedDate = transportDate;
    ...
    public class TitlePanel extends JPanel {
        ...
        public static final long serialVersionUID = -2865282186037420798L;
        public JLabel preYear,preMonth,center,nextMonth,nextYear,centercontainer;
        ...
        public void initTitlePanel(){
            preYear = new JLabel("<<", SwingConstants.CENTER);
            preMonth = new JLabel("<", SwingConstants.CENTER);
            center = new JLabel("", SwingConstants.CENTER);
            centercontainer = new JLabel("", SwingConstants.CENTER);
            nextMonth = new JLabel(">", SwingConstants.CENTER);
            nextYear = new JLabel(">>", SwingConstants.CENTER);
    ...
    public class BodyPanel extends JPanel {
        ...
        public static final long serialVersionUID = 5677718768457235447L;
    ...
    public class FooterPanel extends JPanel {
        ...
        public static final long serialVersionUID = 8135037333899746736L;
    ...
    public class WeekLabel extends JLabel {
        ...
        public static final long serialVersionUID = -8053965084432740110L;
        public String name;
    ...
    public class DayLabel extends JLabel implements java.util.Comparator<DayLabel>, java.awt.event.MouseListener, java.awt.event.MouseMotionListener {

        public static final long serialVersionUID = -6002103678554799020L;
        public boolean isSelected;
        public int year, month, day;
        
        public DayLabel(Calendar cal){
            super(""+cal.get(Calendar.DAY_OF_MONTH), SwingConstants.CENTER);
