...
public class CarUpdateJFrame extends javax.swing.JFrame {
     ...
     */
    public CarUpdateJFrame(CarEntity car) {
    	this.car = car;
        initComponents();
    }
    ...
    private void initComponents() {
      ...
      //将car的信息复制到Panel�??
        jTextField1.setText(Integer.toString(car.getId()));
        jTextField2.setText(car.getNumber());
        jTextField3.setText(car.getXinghao());
        jTextField4.setText(car.getF_number());
        jTextField5.setText(car.getJ_number());
        jTextField6.setText(car.getSelltime().toString());
        jTextField7.setText(car.getInf());
        jComboBox1.setSelectedItem(car.getType());
        jComboBox2.setSelectedItem(car.getState());
